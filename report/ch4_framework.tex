...
the UCT algorithm and the modifications we have made in order to improve
its applicability in NLG.  We present STRUCT's pseudocode, and describe
...
We refer to STRUCT using our perfectly correct algorithm as STRUCT$_a$, and STRUCT
