...
\include{prelude}                % Title page, committee approval sheet, abstract, table of contents, etc
...
\include{ch3_relwork}
\chapter{The STRUCT System}
\include{ch4_framework}
\chapter{Experiments}
\include{ch5_experiment}
\chapter{Conclusion}
