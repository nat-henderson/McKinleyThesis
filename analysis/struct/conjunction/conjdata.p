...
plot "conjdata.data" using 1:2 title "One Entity" with lines ls 1, \
     "conjdata.data" using 1:3 title "Two Entities" with lines ls 3, \
     "conjdata.data" using 1:4 title "Three Entities" with lines ls 2
